...
class DEMO_BANK_MOVEMENT14StackAdvisor(DefaultStackAdvisor):
    ...
    for service in services["services"]:
      ...
      for component in slaveClientComponents:
        ...
        if self.isComponentHostsPopulated(component):
          ...
          hostsForComponent = ['keedio4.jflxti0qonie1hrlkmh54csqcg.fx.internal.cloudapp.net','keedio5.jflxti0qonie1hrlkmh54csqcg.fx.internal.cloudapp.net','keedio6.jflxti0qonie1hrlkmh54csqcg.fx.internal.cloudapp.net']
        elif componentName=="ELASTICSEARCH_INDEXER":
          hostsForComponent = ['keedio7.jflxti0qonie1hrlkmh54csqcg.fx.internal.cloudapp.net']
        elif componentName=="FLUME_HANDLER":
          hostsForComponent = ['keedio9.jflxti0qonie1hrlkmh54csqcg.fx.internal.cloudapp.net','keedio10.jflxti0qonie1hrlkmh54csqcg.fx.internal.cloudapp.net']
        else:
          if len(freeHosts) == 0:
  ...
  def getMastersWithMultipleInstances(self):
    return ['ZOOKEEPER_SERVER', 'HBASE_MASTER', 'COUCHBASE_SERVER', 'KAFKA_BROKER']
