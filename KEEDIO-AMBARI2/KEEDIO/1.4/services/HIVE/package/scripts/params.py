...
hive_metastore_warehouse = config['configurations']['hive-site']['hive.metastore.warehouse.dir']
...
is_hive_metastore = hostname in config['clusterHostInfo']['hive_metastore_host']
