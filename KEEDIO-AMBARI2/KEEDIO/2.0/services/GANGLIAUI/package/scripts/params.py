...
ganglia_conf_dir = default("/configurations/gangliaui-env/ganglia_conf_dir", "/etc/ganglia")
ganglia_dir = "/etc/ganglia"
ganglia_runtime_dir = config['configurations']['gangliaui-env']["ganglia_runtime_dir"]
...
gmond_add_clusters_str = default("/configurations/gangliaui-env/additional_clusters", None)
print "XXXXXXXXXXXX", gmond_add_clusters_str
...
rrdcached_base_dir = config['configurations']['gangliaui-env']["rrdcached_base_dir"]
rrdcached_timeout = default("/configurations/gangliaui-env/rrdcached_timeout", 3600)
rrdcached_flush_timeout = default("/configurations/gangliaui-env/rrdcached_flush_timeout", 7200)
rrdcached_delay = default("/configurations/gangliaui-env/rrdcached_delay", 1800)
rrdcached_write_threads = default("/configurations/gangliaui-env/rrdcached_write_threads", 4)

ganglia_server_host = config["clusterHostInfo"]["gangliaui_server_hosts"][0]
