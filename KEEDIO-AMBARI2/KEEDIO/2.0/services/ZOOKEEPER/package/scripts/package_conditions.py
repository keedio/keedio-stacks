...
__all__ = ["is_lzo_enabled", "should_install_phoenix", "should_install_ams_collector", "should_install_ams_grafana",
           "should_install_mysql", "should_install_mysl_connector", "should_install_ranger_tagsync", "should_install_zookeeper_server"]
...
from package_conditions import *
...
#def should_install_zookeeper_server():
#  hostname = config['hostname']
#  zookeeper_hosts = config['clusterHostInfo']['zookeeper_hosts']
#  is_zk_server = hostname in  zookeeper_hosts
#  return not is_zk_server      

def should_install_zookeeper_server():
  config = Script.get_config()
  return _has_applicable_local_component(config, ["ZOOKEEPER_SERVER"])

def should_install_zookeeper_rest():
  config = Script.get_config()
  return _has_applicable_local_component(config, ["ZOOKEEPER_REST"])
